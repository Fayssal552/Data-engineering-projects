...
def _fetch_and_save():
    ...
    main_path = "C:/Users/dell/AppData/Local/Temp/json_file"
...
def _send_to_postgresql():
    ...
    json_file_path = 'C:/Users/dell/AppData/Local/Temp/json_file/data_university.json'

    # Connect to the PostgreSQL database
    conn = psycopg2.connect(
        database="airflow", # postgres_db -> airflow
        user="airflow", # i change from user and pwd from postgres to airflow
        password="airflow", 
    ...
    for record in json_data:
        ...
        alpha_two_code = record['alpha_two_code'][:2]
        name = record['name']
    ...
    cursor.close()
    conn.close()
    os.remove("C:/Users/dell/AppData/Local/Temp/json_file/data_university.json")
...
def _send_csv_s3():
    with open(CUR_DIR + "/configuration.json","r") as output:
    ...
    s3_client.upload_file(
        "C:/Users/dell/AppData/Local/Temp/csv/data_university.csv",
        configurations["bucket_name"],
        configurations["file_name"])

    os.remove("C:/Users/dell/AppData/Local/Temp/csv/data_university.csv")
...
wait_for_json = PythonSensor(
    ...
    mode="reschedule",
    op_kwargs={
        "filepath":"C:/Users/dell/AppData/Local/Temp/json_file/data_university.json"},
    dag=dag1)
...
trigger_dag2 = TriggerDagRunOperator(
    ...
    trigger_dag_id="get_psql_data_send_s3",
    dag=dag1)

fetch_psql_save_csv = PythonOperator(
    task_id="fetch_psql_save_csv",
    python_callable=_fetch_psql_save_csv,
    op_kwargs={"file_path":"C:/Users/dell/AppData/Local/Temp/csv",
               "csv_path":"C:/Users/dell/AppData/Local/Temp/csv/data_university.csv"},
    dag=dag2)
...
wait_for_csv = PythonSensor(
    ...
    timeout=24*60*60,
    mode="reschedule",
    op_kwargs={"filepath":"C:/Users/dell/AppData/Local/Temp/csv/data_university.csv"},
    dag=dag2)
